...
SELECT COUNT(name) AS total ,course FROM students GROUP BY course; 

SELECT AVG(score) AS 'AVG COURSE' ,course FROM students GROUP BY course HAVING AVG(score) >80; 
